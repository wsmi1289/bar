class RecipesController < ApplicationController
  ...
  # GET /recipes/1.json
  def show
    @ingredients = RecipeIngredient.all.where(recipe_id: params[:id])
  end
  ...
  private
    ...
    def recipe_params
      params.require(:recipe).permit(:name, :directions, recipe_ingredients_attributes:[:id, :quantity, :ingredient_id, :_destroy])
    end
end
